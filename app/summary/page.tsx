...
const FeatureCard: React.FC<FeatureCardProps> = ({ title, items, color }) => (
  <div className={`bg-white rounded-lg shadow-lg p-6 h-full border-t-4 border-${color}-500 relative z-10 overflow-hidden`}>
...
export default function SummaryPage() {
  ...
  <div className="grid md:grid-cols-3 gap-8 mb-20">
          {algorithms.map((algo) => (
            ...
            >
              <div className={`bg-${algo.color}-50 rounded-lg shadow-lg p-6 flex-1 border-t-4 border-${algo.color}-500 relative overflow-hidden`}>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="p-6 bg-green-50 rounded-lg">
              <h3 className="text-lg font-semibold mb-3 text-green-600">⚙️ Automation</h3>
              <ul className="space-y-2 text-gray-600">
